...
export function estado() {
    let listaUsar = (asistente.energia > 5) ? asistente.activa : asistente.cansada;
...
if (botonDescansar) {
    botonDescansar.addEventListener('click', (event) => {
        descansarRaphtalia();
    });
}
//# sourceMappingURL=raphtalia.js.map